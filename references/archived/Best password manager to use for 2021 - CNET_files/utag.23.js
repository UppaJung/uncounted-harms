...
//tealium universal tag - utag.23 ut4.0.202105180049, Copyright 2021 Tealium.com Inc. All Rights Reserved.
...
return i;};u.map={};u.extend=[];if(window.console){window.console.log("Service: facebookmarketing");}
u.send=function(a,b){if(u.ev[a]||u.ev.all!==undefined){var c,d,e,f,g,h,evt=[];u.data={"qsp_delim":"&","kvp_delim":"=","base_url":"https://web.archive.org/web/20210707030336/https://connect.facebook.net/en_US/fbevents.js","cust_pixel":"789754228632403","conv_pixel":"2.0","page_view":"true","calc_items":"true","default_event":"None","custom_data":{},"custom_event":"","product_id":[],"product_name":[],"product_category":[],"product_unit_price":[],"product_quantity":[],"evt_list":[],"ecom":{}};c=[];for(d in utag.loader.GV(u.map)){if(b[d]!==undefined&&b[d]!==""){e=u.map[d].split(",");for(f=0;f<e.length;f++){u.map_func(e[f].split("."),u.data,b[d]);}}else{h=d.split(":");if(h.length===2&&b[h[0]]===h[1]){if(u.map[d]){evt=evt.concat(u.map[d].split(","));}}}}
...
if(_event){fbq(_track,_event,u.remove_empty(g));}}};u.callBack=function(){var data={};u.initialized=true;while(data=u.queue.shift()){u.data=data.data;u.loader_cb();}};if(u.initialized){u.loader_cb();}else{u.queue.push({"data":u.data});if(!u.scriptrequested){u.scriptrequested=true;u.loader({"type":"script","src":u.data.base_url,"cb":u.callBack,"loc":"script","id":'utag_23'});!function(f,b,e){if(f.fbq)return;e=f.fbq=function(){e.callMethod?e.callMethod.apply(e,arguments):e.queue.push(arguments);};if(!f._fbq)f._fbq=e;e.push=e;e.loaded=!0;e.version='2.0';e.queue=[];e.agent='tmtealium';}(window,document);if(u.data.cust_pixel){u.data.cust_pixel=u.data.cust_pixel.split(/\s*,\s*/);for(var i=0;i<u.data.cust_pixel.length;i++){u.data.cust_pixel[i]=u.data.cust_pixel[i].replace(/^\s*/,"").replace(/\s*$/,"");fbq('dataProcessingOptions',['LDU'],0,0);fbq('init',u.data.cust_pixel[i]);}
if(u.data.page_view==="true"){fbq('track','PageView',u.data.page);}}}}
}};utag.o[loader].loader.LOAD(id);}("23","redventures.cnetglobalsite"));}catch(error){utag.DB(error);}


}
/*
     FILE ARCHIVED ON 03:03:36 Jul 07, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:06:24 May 13, 2023.
...
/*
playback timings (ms):
  captures_list: 135.521
  exclusion.robots: 0.074
  exclusion.robots.policy: 0.063
  cdx.remote: 0.087
  esindex: 0.011
  LoadShardBlock: 99.426 (3)
  PetaboxLoader3.datanode: 84.095 (4)
  load_resource: 189.935
  PetaboxLoader3.resolve: 80.639
*/