...
//tealium universal tag - utag.38 ut4.0.202101290237, Copyright 2021 Tealium.com Inc. All Rights Reserved.
...
u.loader_cb=function(g){u.initialized=true;window.google_trackConversion(g);};u.callBack=function(){var data={};while(data=u.queue.shift()){u.loader_cb(data.g);}};if(u.initialized){u.loader_cb(g);}else{u.queue.push({"g":g});if(!u.scriptrequested){u.scriptrequested=true;u.loader({"type":"script","src":u.data.base_url,"cb":u.callBack,"loc":"script","id":"utag_38"});}}
}};utag.o[loader].loader.LOAD(id);}("38","redventures.cnetglobalsite"));}catch(error){utag.DB(error);}
...
/*
playback timings (ms):
  captures_list: 236.298
  exclusion.robots: 0.072
  exclusion.robots.policy: 0.063
  cdx.remote: 0.053
  esindex: 0.009
  LoadShardBlock: 205.098 (3)
  PetaboxLoader3.datanode: 129.304 (4)
  PetaboxLoader3.resolve: 235.017 (2)
  load_resource: 213.738
*/